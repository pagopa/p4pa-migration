...
@Slf4j
public class AssessmentsRegistryMigrationFileTypeHandlerActivityImpl extends BaseMigrationFileTypeHandlerActivity<MigrationFileResult> implements AssessmentsRegistryMigrationFileTypeHandlerActivity {

  public AssessmentsRegistryMigrationFileTypeHandlerActivityImpl(
  ...
  protected MigrationFileTypeEnum getHandledMigrationFileType() {
    return MigrationFileTypeEnum.ASSESSMENTS_REGISTRY;
  }
  ...
  protected MigrationFileResult handleRetrievedFiles(List<Path> retrievedFiles, Uploads upload) {
    return handleFilesUpload(
      retrievedFiles,
      upload,
      IngestionFlowFileType.ASSESSMENTS_REGISTRY,
