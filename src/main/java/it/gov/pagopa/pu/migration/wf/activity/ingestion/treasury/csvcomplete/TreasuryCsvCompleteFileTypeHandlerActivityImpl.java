...
@Slf4j
public class TreasuryCsvCompleteFileTypeHandlerActivityImpl extends BaseMigrationFileTypeHandlerActivity<MigrationFileResult> implements TreasuryCsvCompleteFileTypeHandlerActivity {

  public TreasuryCsvCompleteFileTypeHandlerActivityImpl(
  ...
  protected MigrationFileTypeEnum getHandledMigrationFileType() {
    return MigrationFileTypeEnum.TREASURY_CSV_COMPLETE;
  }
  ...
  protected MigrationFileResult handleRetrievedFiles(List<Path> retrievedFiles, Uploads upload) {
    return handleFilesUpload(
      retrievedFiles,
      upload,
      IngestionFlowFileType.TREASURY_CSV_COMPLETE
    );
  }
}
