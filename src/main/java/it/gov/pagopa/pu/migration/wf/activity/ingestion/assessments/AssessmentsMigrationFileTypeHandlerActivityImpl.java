...
@Slf4j
public class AssessmentsMigrationFileTypeHandlerActivityImpl extends BaseMigrationFileTypeHandlerActivity<MigrationFileResult> implements AssessmentsMigrationFileTypeHandlerActivity {

  public AssessmentsMigrationFileTypeHandlerActivityImpl(
  ...
  protected MigrationFileTypeEnum getHandledMigrationFileType() {
    return MigrationFileTypeEnum.ASSESSMENTS;
  }
  ...
  protected MigrationFileResult handleRetrievedFiles(List<Path> retrievedFiles, Uploads upload) {
    return handleFilesUpload(
      retrievedFiles,
      upload,
      IngestionFlowFileType.ASSESSMENTS,
      IngestionFlowFile.IngestionFlowFileTypeEnum.ASSESSMENTS
    );
  }
}
