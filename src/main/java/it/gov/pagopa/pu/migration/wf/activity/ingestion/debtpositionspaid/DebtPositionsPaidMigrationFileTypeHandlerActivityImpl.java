...
@Slf4j
public class DebtPositionsPaidMigrationFileTypeHandlerActivityImpl extends BaseMigrationFileTypeHandlerActivity<MigrationFileResult> implements DebtPositionsPaidMigrationFileTypeHandlerActivity {

  public DebtPositionsPaidMigrationFileTypeHandlerActivityImpl(
  ...
  protected MigrationFileTypeEnum getHandledMigrationFileType() {
    return MigrationFileTypeEnum.DEBT_POSITIONS_PAID;
  }
