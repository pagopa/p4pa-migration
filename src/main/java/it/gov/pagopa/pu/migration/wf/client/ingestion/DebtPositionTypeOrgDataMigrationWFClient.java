...
@Service
@Slf4j
public class DebtPositionTypeOrgDataMigrationWFClient implements DataMigrationWfClient {

  private final WorkflowService workflowService;
  private final WorkflowClientService workflowClientService;

  public DebtPositionTypeOrgDataMigrationWFClient(WorkflowService workflowService, WorkflowClientService workflowClientService) {
  ...
  public WorkflowCreatedDTO migrate(Long uploadId) {
    ...
    String workflowId = WfUtilities.generateWorkflowId(uploadId, DebtPositionTypeOrgDataMigrationWF.class);

    DebtPositionTypeOrgDataMigrationWF workflow = workflowService.buildWorkflowStub(
      DebtPositionTypeOrgDataMigrationWF.class,
      taskQueue,
      workflowId);
