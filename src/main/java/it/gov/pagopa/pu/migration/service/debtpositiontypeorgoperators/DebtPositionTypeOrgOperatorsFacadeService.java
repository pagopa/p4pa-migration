...
public interface DebtPositionTypeOrgOperatorsFacadeService {
  ...
  void consumeDebtPositionTypeOrgOperators(Long organizationId, ConsumeDebtPositionTypeOrgOperatorsDTO consumeDebtPositionTypeOrgOperatorsDTO, UserInfo loggedUser);
}
