...
@Slf4j
public class OrgSilServiceMigrationFileTypeHandlerActivityImpl extends BaseMigrationFileTypeHandlerActivity<MigrationFileResult> implements OrgSilServiceMigrationFileTypeHandlerActivity {

  public OrgSilServiceMigrationFileTypeHandlerActivityImpl(
  ...
  protected MigrationFileTypeEnum getHandledMigrationFileType() {
    return MigrationFileTypeEnum.ORG_SIL_SERVICES;
  }
  ...
  protected MigrationFileResult handleRetrievedFiles(List<Path> retrievedFiles, Uploads upload) {
    return handleFilesUpload(
      retrievedFiles,
      upload,
      IngestionFlowFileType.ORGANIZATIONS_SIL_SERVICE,
      IngestionFlowFile.IngestionFlowFileTypeEnum.ORGANIZATIONS_SIL_SERVICE
    );
  }
}
